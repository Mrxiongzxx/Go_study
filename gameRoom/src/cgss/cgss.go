...
import (
	"awesomeProject/go_study/gameRoom/src/cg"
	"awesomeProject/go_study/gameRoom/src/ipc"
	"bufio"
	"fmt"
	"os"
	"strconv"
...
func Send(args []string) int {
	...
	err := centerClient.BroadPlayer(message)
	if err != nil {
		fmt.Println("Failed.",err)
	}
...
func main()  {
	fmt.Println("zxx GameRoom Server Solution")
